...
if (!isset($_SESSION['login']) || $_SESSION['login'] !== true) {
    header("Location: ../admin?pesan=belum_login"); // arahkan ke halaman login
    exit();
}
?>
...
<div class="container-dashboard bg-none" style="margin-top: 10rem;">
    <div class="text-welcome m-8">
        <h1 class="text-green-800 font-bold text-[3rem] max-sm:text-[2.562]" data-aos="fade-down" data-aos-delay="100">RUMAH BACA ULIL ALBAB</h1>
