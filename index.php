...
<section class="relative h-[80vh] md:h-[90vh] overflow-hidden">
  <!-- Background image -->
  ...
  <!-- Gradient overlay -->
  <div class="absolute inset-0 bg-gradient-to-r from-[var(--rb-green)]/90 via-[var(--rb-green)]/70 to-transparent z-10"></div>

  <!-- Subtle pattern overlay -->
  <div class="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 z-20"></div>

  <!-- Main content -->
  <div class="relative z-30 w-full h-full flex flex-col md:flex-row items-center justify-center md:justify-between px-6 sm:px-10 lg:px-16">
    
    <!-- Left Text Content -->
    <div class="max-w-lg md:max-w-2xl text-white" data-aos="fade-right" data-aos-delay="150">
      <span class="inline-block bg-white/20 px-4 py-1 mt-8 md:mt-2 rounded-full text-sm tracking-wide shadow">
        📚 Program Rumah Baca
      </span>
      <h1 class="mt-6 text-3xl sm:text-5xl md:text-6xl font-extrabold leading-tight drop-shadow-lg">
        Rumah Baca <span class="text-orange-300">Ulil Albab</span>
      </h1>
      <p class="mt-4 text-base sm:text-lg md:text-xl text-white/90 leading-relaxed">
        Membangun budaya baca — ruang belajar, ruang bermain, ruang berbagi pengetahuan 
    ...
    <div class="hidden md:flex relative" data-aos="fade-left" data-aos-delay="300">
      <div class="absolute -top-10 -left-10 w-60 sm:w-72 h-60 sm:h-72 rounded-full bg-orange-400/20 blur-3xl animate-pulse"></div>
      <img src="https://images.unsplash.com/photo-1596495577886-d920f1fb7238?q=80&w=500&auto=format&fit=crop"
           alt="Buku dekoratif"
           class="relative w-48 sm:w-60 lg:w-72 rounded-xl shadow-2xl transform hover:rotate-2 hover:scale-105 transition duration-500">
    </div>

  </div>

  <!-- Floating small elements -->
  <div class="absolute top-20 right-6 sm:right-10 w-10 h-10 bg-white/20 rounded-full animate-bounce z-20"></div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row gap-12 items-center">
    ...
    <div class="will-animate lg:order-2" data-aos="fade-right">
      ...
      <p class="text-slate-700 leading-relaxed mb-6">
        Di pelosok Sumatera Utara, akses terhadap bacaan masih sangat terbatas. 
        Banyak desa belum memiliki <span class="font-semibold text-[var(--rb-orange)]">pusat baca</span>, 
        padahal literasi adalah kunci membuka masa depan. 
        Rumah Baca Pelosok hadir untuk menjembatani kesenjangan ini.
      </p>
      <p class="text-slate-700 leading-relaxed mb-6">
        Melalui penyediaan rumah baca, gerakan donasi buku, dan pembinaan masyarakat, 
        kami berkomitmen menghadirkan <span class="font-semibold">kesetaraan akses pengetahuan</span>, 
        menumbuhkan minat baca, dan mendukung terwujudnya Generasi Emas Indonesia 2045.
      </p>
      ...
      <div class="grid sm:grid-cols-2 gap-4 mt-6">
        <div class="bg-white shadow rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-slate-600">Rumah baca di 14 desa, dengan target ≥ 2.000 buku sesuai rekomendasi Perpusnas.</p>
          </div>
        </div>
        <div class="bg-white shadow rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-slate-600">Membaca, menulis, bercerita, hingga pembinaan pendidikan tinggi.</p>
          </div>
        </div>
        <div class="bg-white shadow rounded-xl p-4 flex items-start gap-3">
          <div class="h-10 w-10 flex items-center justify-center rounded-lg bg-emerald-100 text-[var(--rb-green)] text-lg">🤝</div>
          <div>
            <h3 class="font-semibold">Kolaborasi</h3>
            <p class="text-sm text-slate-600">Bersama perpustakaan, universitas, penerbit, komunitas, dan BUMN.</p>
          </div>
        </div>
        <div class="bg-white shadow rounded-xl p-4 flex items-start gap-3">
          <div class="h-10 w-10 flex items-center justify-center rounded-lg bg-orange-100 text-[var(--rb-orange)] text-lg">🌱</div>
          <div>
            <h3 class="font-semibold">Kesetaraan Akses</h3>
            <p class="text-sm text-slate-600">Anak-anak, remaja, ibu rumah tangga, hingga disabilitas dapat membaca.</p>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-12">
        <div class="flex flex-col items-center">
          <div class="w-24 h-24 rounded-full bg-emerald-100 flex flex-col justify-center items-center shadow-md relative">
            ...
            <h3 class="text-lg font-bold text-[var(--rb-green)] counter" data-target="2000">0</h3>
          </div>
        ...
        <div class="flex flex-col items-center">
          <div class="w-24 h-24 rounded-full bg-orange-100 flex flex-col justify-center items-center shadow-md relative">
            <img src="image/children.png" alt="" class="w-12 h-12">
        ...
        <div class="flex flex-col items-center">
          <div class="w-24 h-24 rounded-full bg-emerald-100 flex flex-col justify-center items-center shadow-md relative">
            <img src="image/volunteer.png" alt="" class="w-12 h-12">
        ...
        <div class="flex flex-col items-center">
          <div class="w-24 h-24 rounded-full bg-orange-100 flex flex-col justify-center items-center shadow-md relative">
            <img src="image/school.png" alt="" class="w-12 h-12">
    ...
    <div class="relative will-animate lg:order-1 flex justify-center lg:justify-end" data-aos="fade-left">
      ...
      <div class="relative w-[18rem] h-[12rem] md:w-[25rem] md:h-[16rem] lg:w-[27rem] lg:h-[19rem]">
        <img src="image/tentang-kami.jpg" alt="Anak-anak belajar bersama"
          class="rounded-2xl shadow-xl object-cover w-full h-full">
      </div>
      <!-- Gambar kecil (overlay) -->
      <div class="absolute -bottom-8 -left-8 w-[11rem] h-[7rem] md:w-[15rem] md:h-[10rem] rotate-40 border-4 border-white rounded-xl shadow-lg">
        <img src="image/tentang-kami2.jpg" alt="Suasana membaca"
...
<!-- SEBARAN (peta pulau) -->
<section class="relative py-20 bg-gradient-to-b from-[var(--rb-green)]/10 via-white to-white overflow-x-hidden">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12 will-animate" data-aos="fade-up">
        ...
        <!-- Map container -->
      <div class="relative max-w-7xl mx-auto will-animate" data-aos="zoom-in">
        <div class="relative">
          <img src="image/peta2.png" 
              alt="Peta Indonesia" 
              class="w-[80rem] rounded-xl animate-fadeIn">

          <!-- Banda Aceh -->
          <div class="absolute top-[15%] left-[30%] group">
            ...
            <div class="absolute left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
              ...
              <span class="font-semibold text-[var(--rb-green)]">Banda Aceh</span><br>
              Rumah Baca Banda Aceh
            </div>
          </div>

          <!-- Medan -->
          <div class="absolute top-[28%] left-[40%] group">
            <button class="pulse-dot"></button>
            <div class="absolute left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
                        transition-all duration-300 transform group-hover:translate-x-2 
                        bg-white text-sm text-slate-700 shadow-lg border rounded-lg px-4 py-2">
          ...
          <!-- Pematangsiantar -->
          <div class="absolute top-[33%] left-[43%] group">
            <button class="pulse-dot"></button>
            <div class="absolute left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
                        transition-all duration-300 transform group-hover:translate-x-2 
                        bg-white text-sm text-slate-700 shadow-lg border rounded-lg px-4 py-2">
              <span class="font-semibold text-[var(--rb-green)]">Pematangsiantar</span><br>
              Rumah Baca Pematangsiantar
            </div>
          </div>

          <!-- Dumai -->
          <div class="absolute top-[36%] left-[48%] group">
            <button class="pulse-dot"></button>
            <div class="absolute left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
                        transition-all duration-300 transform group-hover:translate-x-2 
                        bg-white text-sm text-slate-700 shadow-lg border rounded-lg px-4 py-2">
              <span class="font-semibold text-[var(--rb-green)]">Dumai</span><br>
              Rumah Baca Dumai
            </div>
          </div>

          <!-- Pekanbaru -->
          <div class="absolute top-[42%] left-[48%] group">
            <button class="pulse-dot"></button>
            <div class="absolute left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
                        transition-all duration-300 transform group-hover:translate-x-2 
                        bg-white text-sm text-slate-700 shadow-lg border rounded-lg px-4 py-2">
              <span class="font-semibold text-[var(--rb-green)]">Pekanbaru</span><br>
              Rumah Baca Pekan Baru
            </div>
          </div>

          <!-- Jambi -->
          <div class="absolute top-[52%] left-[54%] group">
            <button class="pulse-dot"></button>
            <div class="absolute left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
                        transition-all duration-300 transform group-hover:translate-x-2 
                        bg-white text-sm text-slate-700 shadow-lg border rounded-lg px-4 py-2">
              <span class="font-semibold text-[var(--rb-green)]">Jambi</span><br>
              Rumah Baca Jambi
            </div>
          </div>

          <!-- Palembang -->
          <div class="absolute top-[60%] left-[58%] group">
            <button class="pulse-dot"></button>
            <div class="absolute left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
                        transition-all duration-300 transform group-hover:translate-x-2 
                        bg-white text-sm text-slate-700 shadow-lg border rounded-lg px-4 py-2">
              <span class="font-semibold text-[var(--rb-green)]">Palembang</span><br>
              Rumah Baca Palembang
            </div>
          </div>

          <!-- Pangkalpinang -->
          <div class="absolute top-[65%] left-[52%] group">
            <button class="pulse-dot"></button>
            <div class="absolute left-4 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 
                        transition-all duration-300 transform group-hover:translate-x-2 
                        bg-white text-sm text-slate-700 shadow-lg border rounded-lg px-4 py-2">
              <span class="font-semibold text-[var(--rb-green)]">Bengkulu</span><br>
              Rumah Baca Bengkulu
            </div>
          </div>
        </div>
...
<!-- DONATION CTA -->
<section id="donate" class="relative py-24 bg-green-800 text-white overflow-hidden">
