...
<section class="relative py-28 pb-[12rem] bg-gradient-to-r from-emerald-50 via-white to-orange-50 overflow-hidden" id="program">
  <div class="max-w-6xl mx-auto px-6 pt-20 grid md:grid-cols-2 gap-12 items-center">
    ...
    <div class="relative z-10" data-aos="fade-right">
      <h1 class="text-4xl md:text-5xl font-extrabold text-emerald-900 mb-8 leading-tight">
        Program <span class="text-orange-600">Rumah Baca</span>
      </h1>

      <div class="space-y-6 text-lg md:text-xl text-slate-700 leading-relaxed">
        <p data-aos="fade-right" data-aos-delay="100">
          Kami percaya setiap <span class="text-emerald-700 font-semibold">halaman buku</span> 
          adalah jendela menuju dunia baru.
        </p>
        <p data-aos="fade-right" data-aos-delay="200">
          Di sini, <span class="text-orange-600 font-semibold">literasi</span> bukan hanya tentang membaca,  
          tetapi juga <span class="text-emerald-700 font-semibold">membangun karakter</span>  
          dan membuka kesempatan.
        </p>
      </div>
    </div>

    <!-- Right Highlight - Creative Quote -->
    <div class="relative flex flex-col justify-center items-start md:items-center" data-aos="fade-left" data-aos-delay="150">
      <div class="bg-white p-8 rounded-2xl shadow-md border-t-4 border-emerald-600">
        <blockquote class="text-2xl md:text-3xl font-semibold text-slate-800 leading-relaxed">
          “Program kami hadir untuk <span class="text-orange-600">menginspirasi</span>,  
          <span class="text-emerald-700">menggerakkan</span>, dan menumbuhkan semangat belajar.”
        </blockquote>
      </div>
    </div>
  ...
  <!-- Decorative Shapes -->
  <div class="absolute -top-10 -left-10 w-40 h-40 bg-emerald-200 rounded-full blur-3xl opacity-40"></div>
  <div class="absolute bottom-0 right-0 w-56 h-56 bg-orange-200 rounded-full blur-3xl opacity-40"></div>
</section>
  ...
  <div class="container mx-auto px-6 lg:px-16 flex flex-col lg:flex-row items-center gap-10" data-aos="zoom-in">
    ...
    <div class="lg:w-1/2 text-center lg:text-left relative z-10">
      ...
      <p class="text-gray-600 mb-6">
        Festival tahunan yang menghadirkan lomba menulis, bedah buku, workshop kreatif, 
        hingga pameran komunitas.  
        Dihadiri ratusan peserta dari berbagai kalangan dan menjadi ajang silaturahmi pecinta literasi.
      </p>
      <a href="#program-unggulan" 
         class="inline-block px-6 py-3 bg-gradient-to-r from-green-600 to-orange-500 text-green-900 font-semibold rounded-xl shadow hover:scale-105 hover:shadow-lg transition">
        Lihat Detail
      </a>
    </div>
  </div>
...
<!-- Program Section -->
<section id="program-unggulan" class="py-20 relative bg-gradient-to-tr from-orange-50 via-white to-green-50">
    ...
    <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition group relative" data-aos="fade-up">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">
            Menumbuhkan budaya membaca melalui taman baca, kelas membaca, bedah buku, 
            serta pelatihan menulis dan jurnalistik.
          </p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition group relative" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">
            Mendukung pendidikan anak & remaja dengan bimbingan belajar, literasi digital, 
            serta pengembangan soft skill untuk masa depan.
          </p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition group relative" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">
            Membuka ruang ekspresi bagi anak-anak dan remaja melalui seni, musik, kerajinan tangan, 
            hingga karya digital.
          </p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition group relative" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">
            Menebar manfaat bagi masyarakat melalui donasi buku, kegiatan relawan, 
      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition group relative" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">
            Kegiatan rutin yang memperkuat ikatan komunitas, seperti lomba literasi, 
            diskusi publik, dan festival baca bersama.
          </p>
        </div>
      </div>
